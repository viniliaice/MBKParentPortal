...
* [Profiles](/supabase/profiles.md) - Parent user accounts
* [Students](/supabase/students.md) - Students linked to parent accounts
* [Exams](/supabase/exams.md) - Subject exam and quiz records
* [Attendance](/supabase/attendance.md) - Daily attendance records per student
* [Messages](/supabase/messages.md) - Parent-teacher direct messages
* [Announcements](/supabase/announcements.md) - School-wide and class-level announcements

## State

* [Auth Context](/state/auth.md) - Login state, persistence, and session management
* [App Context](/state/app.md) - Unified data fetcher and provider for all screens
